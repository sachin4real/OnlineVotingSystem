...
<div class="topnav">
    ...
    <a class="active" href="dancingSlider.php">Dancing</a>
  ...
  <form action='Ddbop.php' method="post">
    ...
    <div class="slideshow-container">
      ...
      <div class="mySlides fade">
        ...
        <img src="jordan-whitfield-sm3Ub_IJKQg-unsplash.jpg" style="width:100%">
      ...
      <div class="mySlides fade">
        ...
        <img src="randalyn-hill-Z1HXJQ2aWIA-unsplash.jpg" style="width:100%">
